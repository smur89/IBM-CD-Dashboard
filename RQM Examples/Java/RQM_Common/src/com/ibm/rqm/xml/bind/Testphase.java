...
@XmlType(name = "", propOrder = {"title", "description", "updated", "state", "creator", "owner", "expectedTotalPoints", "expectedDefects", "expectedValidityRate", "expectedStartDate", "expectedEndDate", "starttime", "endtime", "custom1", "custom2", "custom3", "testplan", "iteration", "detail"})
@XmlRootElement(name = "testphase")
public class Testphase extends ReportableArtifact
{
     ...
     * 
     * @return possible object is {@link Testphase.Testplan }
     */
     ...
     * 
     * @param value
     *            allowed object is {@link Testphase.Testplan }
     */
     ...
     * 
     * @return possible object is {@link Testphase.Iteration }
     */
     ...
     * 
     * @param value
     *            allowed object is {@link Testphase.Iteration }
     */
     ...
     * <p>
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the detail property.
     * <p>
     ...
     * </pre>
     * <p>
     * Objects of the following type(s) are allowed in the list {@link Testphase.Detail }
     */
     ...
     */
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "", propOrder = {"comment", "date", "pointsAttempted", "pointsCompleted"})
