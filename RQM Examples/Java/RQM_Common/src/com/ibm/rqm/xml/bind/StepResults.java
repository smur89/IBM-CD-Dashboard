 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://jazz.net/xmlns/alm/qm/v0.1/executionresult/v0.1}stepResult" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "", propOrder = {"stepResult"})
@XmlRootElement(name = "stepResults", namespace = "http://jazz.net/xmlns/alm/qm/v0.1/executionresult/v0.1")
public class StepResults
{
    
    @XmlElement(namespace = "http://jazz.net/xmlns/alm/qm/v0.1/executionresult/v0.1")
    protected List<StepResult> stepResult;
     ...
     * </pre>
     * <p>
     * Objects of the following type(s) are allowed in the list {@link StepResult }
     */
    public List<StepResult> getStepResult()
    {
        if (stepResult == null)
        {
            stepResult = new ArrayList<StepResult>();
        }
