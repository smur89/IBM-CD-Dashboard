...
public String getGroovyPageFileName() { "/WEB-INF/plugins/google-visualization-0.6.2/grails-app/views/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(5)
invokeTag('pieCoreChart','gvisualization',61,['elementId':("piechart"),'title':("My Daily Activities"),'width':(450),'height':(300),'columns':(myDailyActivitiesColumns),'data':(myDailyActivitiesData)],-1)
printHtmlPart(4)
invokeTag('imagePieChart','gvisualization',62,['elementId':("imagepiechart"),'width':(430),'height':(240),'title':("My Daily Activities"),'columns':(myDailyActivitiesColumns),'data':(myDailyActivitiesData)],-1)
printHtmlPart(4)
invokeTag('barCoreChart','gvisualization',63,['elementId':("barchart"),'title':("Company Performance"),'width':(400),'height':(240),'vAxis':(new Expando(title: 'Year', titleColor: 'red')),'columns':(companyPerformanceColumns),'data':(companyPerformanceData)],-1)
printHtmlPart(4)
invokeTag('imageBarChart','gvisualization',64,['elementId':("imagebarchart"),'width':(400),'height':(240),'min':(0),'columns':(companyPerformanceColumns),'data':(companyPerformanceData)],-1)
printHtmlPart(4)
invokeTag('bubbleCoreChart','gvisualization',65,['elementId':("bubblechart"),'title':("Correlation between life expectancy, fertility rate and population of some world countries (2010)"),'hAxis':(new Expando(title: 'Life Expectancy')),'vAxis':(new Expando(title: 'Fertility Rate')),'bubble':(new Expando(textStyle: '{fontSize: 11}')),'columns':(lifeExpectancyFertilityRateColumns),'data':(lifeExpectancyFertilityRateData)],-1)
printHtmlPart(4)
invokeTag('columnCoreChart','gvisualization',66,['elementId':("columnchart"),'title':("Company Performance"),'width':(400),'height':(240),'hAxis':(new Expando(title: 'Year', titleColor: 'red')),'columns':(companyPerformanceColumns),'data':(companyPerformanceData)],-1)
printHtmlPart(4)
invokeTag('areaCoreChart','gvisualization',67,['elementId':("areachart"),'title':("Company Performance"),'width':(400),'height':(240),'hAxis':(new Expando(title: 'Year', titleColor: 'red')),'columns':(companyPerformanceColumns),'data':(companyPerformanceData)],-1)
printHtmlPart(4)
invokeTag('imageAreaChart','gvisualization',68,['elementId':("imageareachart"),'width':(400),'height':(240),'min':(300),'max':(1400),'title':("Yearly Expenses and Sales"),'columns':(yearlyExpensesColumns),'data':(yearlyExpensesData)],-1)
printHtmlPart(6)
invokeTag('lineCoreChart','gvisualization',69,['elementId':("linechart"),'width':(400),'height':(240),'title':("Company Performance"),'columns':(companyPerformanceColumns),'data':(companyPerformanceData)],-1)
printHtmlPart(4)
invokeTag('imageLineChart','gvisualization',70,['elementId':("imagelinechart"),'width':(400),'height':(240),'min':(0),'columns':(companyPerformanceColumns),'data':(companyPerformanceData)],-1)
printHtmlPart(4)
invokeTag('scatterCoreChart','gvisualization',71,['elementId':("scatterchart"),'width':(400),'height':(240),'title':("Age vs. Weight comparison"),'hAxis':(new Expando(title: 'Age', minValue: 0, maxValue: 15)),'vAxis':(new Expando(title: 'Weight', minValue: 0, maxValue: 15)),'legend':("none"),'columns':(weightByAgeColumns),'data':(weightByAgeData)],-1)
printHtmlPart(4)
invokeTag('steppedAreaCoreChart','gvisualization',72,['elementId':("steppedareachart"),'width':(400),'height':(240),'title':("The decline of \'The 39 Steps\'"),'vAxis':(new Expando(title: 'Accumulated Rating')),'isStacked':(true),'columns':(accumulatedRatingColumns),'data':(accumulatedRatingData)],-1)
printHtmlPart(4)
invokeTag('candlestickCoreChart','gvisualization',73,['elementId':("candlestickchart"),'legend':("none"),'columns':(countByDayColumns),'data':(countByDayData),'candlestick':(new Expando(candlestickOptions))],-1)
printHtmlPart(4)
invokeTag('comboCoreChart','gvisualization',74,['elementId':("combochart"),'title':("Monthly Coffee Production by Country"),'vAxis':(new Expando(title: 'Cups')),'hAxis':(new Expando(title: 'Month')),'seriesType':("bars"),'series':(new Expando(5: new Expando(type: 'line'))),'columns':(monthlyCoffeeProdByCountryColumns),'data':(monthlyCoffeeProdByCountryData)],-1)
printHtmlPart(4)
invokeTag('imageSparkLine','gvisualization',75,['elementId':("imagesparkline"),'width':(120),'height':(40),'showAxisLines':(false),'showValueLabels':(false),'labelPosition':("left"),'columns':(revenueAndLicensesColumns),'data':(revenueAndLicensesData)],-1)
printHtmlPart(4)
invokeTag('imageCandlestickChart','gvisualization',76,['elementId':("imagecandlestickchart"),'columns':(gainersLoserColumns),'data':(gainersLoserData)],-1)
printHtmlPart(4)
invokeTag('gauge','gvisualization',77,['elementId':("gauge"),'width':(400),'height':(120),'redFrom':(90),'redTo':(100),'yellowFrom':(75),'yellowTo':(90),'minorTicks':(5),'columns':(systemPerformanceColumns),'data':(systemPerformanceData)],-1)
printHtmlPart(4)
invokeTag('table','gvisualization',78,['elementId':("table"),'width':(400),'height':(130),'columns':(employeeColumns),'data':(employeeData),'select':("selectHandler"),'ready':("readyHandler")],-1)
printHtmlPart(4)
invokeTag('map','gvisualization',79,['elementId':("map"),'columns':(mapColumns),'data':(mapData)],-1)
printHtmlPart(4)
invokeTag('annotatedTimeLine','gvisualization',80,['elementId':("annotatedtimeline"),'columns':(pensColumns),'data':(pensData)],-1)
printHtmlPart(4)
invokeTag('orgChart','gvisualization',81,['elementId':("orgchart"),'allowHtml':(true),'columns':(orgColumns),'data':(orgData)],-1)
printHtmlPart(4)
invokeTag('intensityMap','gvisualization',82,['elementId':("intensitymap"),'columns':(populationColumns),'data':(populationData)],-1)
printHtmlPart(4)
invokeTag('geoMap','gvisualization',83,['elementId':("geomap"),'columns':(popularityColumns),'data':(popularityData)],-1)
printHtmlPart(4)
invokeTag('geoChart','gvisualization',84,['elementId':("geochart"),'width':(556),'height':(347),'columns':(popularityColumns),'data':(popularityData)],-1)
printHtmlPart(4)
invokeTag('motionChart','gvisualization',85,['elementId':("motionchart"),'columns':(fruitColumns),'data':(fruitData)],-1)
printHtmlPart(4)
invokeTag('treeMap','gvisualization',86,['elementId':("treemap"),'minColor':("#f00"),'midColor':("#ddd"),'maxColor':("#0d0"),'headerHeight':(15),'fontColor':("black"),'showScale':(true),'columns':(marketByRegionColumns),'data':(marketByRegionData)],-1)
printHtmlPart(7)
})
...
public static final long LAST_MODIFIED = 1368124680000L
