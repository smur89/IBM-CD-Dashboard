...
@XmlType(name = "", propOrder = {"title", "description", "alias", "category", "settingsids"})
@XmlRootElement(name = "project")
public class Project extends ReportableArtifact
{
     ...
     * </pre>
     * <p>
     * Objects of the following type(s) are allowed in the list {@link Project.Category }
     */
     ...
     * 
     * @return possible object is {@link Project.Settingsids }
     */
     ...
     * 
     * @param value
     *            allowed object is {@link Project.Settingsids }
     */
     ...
     */
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "", propOrder = {"settingid"})
    public static class Settingsids
    {
         ...
         * <p>
         * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the settingid property.
         * <p>
         * For example, to add a new item, do as follows:
         * 
         * <pre>
