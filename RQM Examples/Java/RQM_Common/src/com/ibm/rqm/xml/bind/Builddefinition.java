...
@XmlType(name = "", propOrder = {"title", "description", "updated", "state", "creator", "owner", "providerTypeId", "status", "buildrecord"})
@XmlRootElement(name = "builddefinition")
public class Builddefinition extends ReportableArtifact
{
     ...
     * <p>
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the buildrecord property.
     * <p>
     ...
     * </pre>
     * <p>
     * Objects of the following type(s) are allowed in the list {@link Builddefinition.Buildrecord }
     */
