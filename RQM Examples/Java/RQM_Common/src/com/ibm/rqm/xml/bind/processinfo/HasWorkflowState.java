 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://jazz.net/xmlns/prod/jazz/rqm/process/1.0/}WorkflowState"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "", propOrder = {"workflowState"})
@XmlRootElement(name = "hasWorkflowState")
public class HasWorkflowState
{
    
    @XmlElement(name = "WorkflowState", required = true)
     ...
     * 
     * @param value
     *            allowed object is {@link WorkflowState }
     */
